...
function initiateAds() {
  ...
  if (gtag && gtag.apiReady) {
    ...
    const allGoogleAdSpaces = [
      { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [970, 250], id: 'div-gpt-ad-home-0', },
      { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [970, 250], id: 'div-gpt-ad-home-1', },
      { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [970, 250], id: 'div-gpt-ad-home-2', },
      { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [728, 90], id: 'div-gpt-ad-1599554538840-0' },
      { slot: '/22150420070/adxp_mytrendingstories_rectangle_1', size: [300, 250], id: 'div-gpt-ad-1599554575619-0' },
    ...
    for (let i = 0; i < size; i++) {
      ...
      allGoogleAdSpaces.push(
        { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [970, 250], id: `dynamic_billboard_ad_${i}` }
      );

      // for billboard ads
      allGoogleAdSpaces.push(
        { slot: '/22150420070/adxp_mytrendingstories_billboard', size: [728, 90], id: `dynamic_leaderboard_ad_${i}` }
      );

      // for mRectangle ads
      allGoogleAdSpaces.push(
        { slot: '/22150420070/adxp_mytrendingstories_rectangle_2', size: [300, 250], id: `dynamic_mrectangle_ad_${i}` }
      );
    }
