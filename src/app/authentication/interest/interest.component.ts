...
export class InterestComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, public categoryService: CategoryService, private router: Router, private modalService: NzModalService, private userService: UserService, public translate: TranslateService, private language: LanguageService
    ) { }
