...
@Component({
  selector: 'app-hair-salon-lead-form',
  templateUrl: './hair-salon-lead-form.component.html',
  styleUrls: ['./hair-salon-lead-form.component.scss']
})
export class HairSalonLeadFormComponent implements OnInit {

  @Input() hairSalonId: string;
  ...
  @ViewChild('recaptcha') set SetThing(e: HairSalonLeadFormComponent) {
  ...
  saveDataOnServer(formData) {
    this.hairSalonService.createHairSalonLead(this.hairSalonId, formData).then(data => {
